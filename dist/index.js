...
// src/index.js
var COMMENT_SIGNATURE = sub("\u{1F916} This report was automatically generated by [pkg-size-action](https://github.com/pkg-size/action/)");
(async () => {
  ...
  const sizeReport = await generate_size_report_default({
    pr,

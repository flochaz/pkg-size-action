...
var require_dist_node5 = __commonJS({
  "node_modules/@octokit/request/dist-node/index.js"(exports2) {
    ...
    function fetchWrapper(requestOptions) {
      const log6 = requestOptions.request && requestOptions.request.log ? requestOptions.request.log : console;
      ...
      return fetch(requestOptions.url, Object.assign({
        ...
        if ("deprecation" in headers) {
          ...
          log6.warn(`[@octokit/request] "${requestOptions.method} ${requestOptions.url}" is deprecated. It is scheduled to be removed on ${headers.sunset}${deprecationLink ? `. See ${deprecationLink}` : ""}`);
        }
